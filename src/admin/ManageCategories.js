...
const ManageCategories = () => {
    ...
    return (
      ...
      <h2 className="mb-4 text-dark">List of Categories in Store</h2>
      
      <div className="row bg-white border border-success">
        <div className="col-12">
          <h2 className="text-center text-info my-3">Total {categories.length} categories</h2>
