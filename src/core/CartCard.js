...
const Card = ({product,addToCart = true,removeFromCart = false, setReload = f => f , reload=undefined}) => {
  ...
  return (
    <div className="card text-dark bg-light border border-info mb-2" style={{minHeight:"50%", width:"70%"}} >
      <div className="card-header font-weight-bold" style={{fontSize:"18px"}}>{cardTitle}</div>
